...
require_once PROJECT_ROOT . '/shared/UnifiedQueryEngine.php';
require_once PROJECT_ROOT . '/shared/LinkPatterns.php';
...
$expectedToken = ConfigService::getInstance()->get('TELEGRAM_WEBHOOK_SECRET');
if (empty($headerToken) || empty($expectedToken) || !hash_equals($expectedToken, $headerToken)) {
...
function mostrarEstadoSistema($botToken, $chatId, $messageId, $user, $db) {
    ...
    try {
        ...
        $filesStatus = [
            ...
            'basededatos.php' => file_exists(INSTALL_DIR . '/basededatos.php'),
