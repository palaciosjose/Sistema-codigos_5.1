<?php
require_once __DIR__ . '/../shared/ConfigService.php';
...
class SimpleCache {
    private static $cache_dir = CACHE_DIR . '/data/';
    ...
    /**
     * Obtener configuraciones usando ConfigService
     */
    public static function get_settings($conn) {
        return ConfigService::getInstance()->getAll();
    }
